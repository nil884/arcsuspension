...
<head>
    ...
    <meta property="og:title" content="Privacy Policy : <?php echo SITE_TITLE; ?>">
    ...
    <meta property="twitter:title" content="Privacy Policy : <?php echo SITE_TITLE; ?>">
...
<div class="main-wrap">     
    ...
    <div class="container pt-3"><div class="row"><div class="col-12"><ul class="breadcrumb p-0 mb-0"><li class="breadcrumb-item"><a href="<?=SITEURL;?>" hreflang="en">Home</a></li><li class="breadcrumb-item active">Privacy Policy</li></ul> </div></div></div>
    <div class="content">
        <div class="container"> 
            <div class="row">
                <div class="col-12 static-page-section">
                    <h1 class="stat-pg-main-title mb-3 h4">Privacy Policy</h1>
                    <? $getdetails=selectQuery(STATIC_PAGE,"privacy_policy","id= 1");
                    echo $getdetails[0]['privacy_policy']; ?>
                </div>
            </div>
        </div>
    </div>
