...
<html lang="en">
<head>
    <title>Vendor Terms and Condition : <?php echo SITE_TITLE; ?></title>
    <meta name="description" content="<?php echo METADESCRIPTION; ?>">
    <meta name="keywords" content="<?php echo METAKEYWORDS; ?>">
    <!--Open Graph / Facebook-->
    <meta property="og:type" content="website">
    <meta property="og:url" content="<?="https://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']; ?>">
    <meta property="og:title" content="Vendor Terms and Condition : <?php echo SITE_TITLE; ?>">
    ...
    <meta property="twitter:title" content="Vendor Terms and Condition : <?php echo SITE_TITLE; ?>">
...
<div class="main-wrap">     
    ...
    <div class="container pt-3"><div class="row"><div class="col-12"><ul class="breadcrumb p-0 mb-0"><li class="breadcrumb-item"><a href="<?=SITEURL;?>" hreflang="en">Home</a></li><li class="breadcrumb-item active"> Vendor Terms and Condition</li></ul></div></div></div>
    <div class="content">
        <div class="container"> 
            <div class="row">
                <div class="col-12 static-page-section">
                    <h1 class="stat-pg-main-title mb-3 h4">Vendor Terms and Condition</h1>
                    <? $getdetails=selectQuery(STATIC_PAGE,"vendor_terms_condition","id= 1");
                    echo $getdetails[0]['vendor_terms_condition']; ?>
                </div>
            </div>
        </div>
    </div>
