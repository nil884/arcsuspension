...
$where = 'master_cat='.$categorydetails[0]['id'];
$productfilters = $prod->getProductsFilters("master_cat",$categorydetails[0]['id']);
$pagetitle = $categorydetails[0]['page_title'];
$bread =  $prod-> getBreadcrumb("master_cat",$categorydetails[0]['id']); ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-wrap">
    ...
    <div class="container">
        <ol class="breadcrumb mb-0 pl-0 pb-0 mb-3"><li class="breadcrumb-item"><a href="<?=SITEURL; ?>" hreflang="en">Home</a></li><li class="breadcrumb-item"><a href="<?=SITEURL.'/'.getUrl("Parent",$bread['parent_id'])?>" class="point1" hreflang="en"><?=$bread['parent']; ?></a></li><li class="breadcrumb-item"><a class="point1" hreflang="en"><?=$bread['master']; ?></a></li></ol>
    </div>
