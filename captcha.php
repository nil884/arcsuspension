...
class phptextClass
{
    ...
    public function phpcaptcha($textColor,$backgroundColor,$imgWidth,$imgHeight,$noiceLines=0,$noiceDots=0,$noiceColor='#EDB993')
    {
        /* Settings */
        $text=$this->random();
        $font = './fonts/monofont.ttf';/* font */
    ...
    $phptextObj->phpcaptcha('#E61F1F','#fff',120,40,10,25);
 ?>