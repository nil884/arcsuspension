...
$getcompnay = selectQuery(BRAND,"brand_name","target_link='".$actual_link."'");
$compnay = $getcompnay[0]['brand_name'];
$where = "prod_company = '".$compnay."'";
$productfilters = $prod->getProductsFilters("prod_company","'".$compnay."'");
$actual_link = ($_SERVER['HTTPS'] == 'on'?"https://":"http://").$_SERVER[HTTP_HOST]."".$_SERVER[REQUEST_URI];
  ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <title>Company Product : <?=SITE_TITLE; ?></title>
    <meta name="description" content="<?=METADESCRIPTION; ?>">
    <meta name="keyword" content="<?=METAKEYWORDS; ?>">
    <!--Open Graph / Facebook-->
    <meta property="og:type" content="website">
    <meta property="og:url" content="<?="https://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']; ?>">
    <meta property="og:title" content="Company Product : <?=SITE_TITLE; ?>">
    ...
    <meta property="twitter:title" content="Company Product : <?=SITE_TITLE; ?>">
...
<div class="main-wrap">
    ...
    <div class="container pt-4 pb-4">        
        <div class="row">
            ...
            <div class="col-md-9">
                <div>
                <h5 class="d-inline-block mb-1">Displaying Product of Company <?=$compnay; ?></h5><span class="text-muted ml-1">(<span class="itmtocount"></span> )</span>
                </div>
