...
<html lang="en">
<head>
    <title><?php echo SITE_TITLE; ?> : RTO Orders</title>
...
<div class="page-body-wrapper">
    ...
    <div class="main-panel">
        <div class="dashbody">
            <div class="card mb-0">
                <div class="card-header sec-card-head justify-content-between align-items-center"><div><h2 class="card-head-title">RTO Orders (<?=$order->getVendorOrdersCount($vendor,"'Rto Acknowledged','Rto Initiated','Rto Delivered','Rto Ofd','Rto Ndr'"); ?>)</h2></div></div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="display table table-bordered neworder-table" >
                            ...
                            <tbody>
                                <?php $orderdata = $order->getVendorOrders($vendor,"'Rto Acknowledged','Rto Initiated','Rto Delivered','Rto Ofd','Rto Ndr'");
                                if(count($orderdata)){
