...
<div class="page-body-wrapper">
    ...
    <div class="main-panel">
        <div class="dashbody">
            <div class="card mb-0">
                <div class="card-header sec-card-head justify-content-between align-items-center"><div><h2 class="card-head-title">Cancelled Order (<?=$order->getVendorOrdersCount($vendor,"'Cancellation Request','Cancellation Requested','Canceled'"); ?>)</h2></div></div>
                <div class="card-body">
                    <table class="display table table-bordered neworder-table w-100">
                        ...
                        <tbody>
                            <?php $orderdata= $order->getVendorOrders($vendor,"'Cancellation Request','Cancellation Requested','Canceled'");
                            if(count($orderdata)){
