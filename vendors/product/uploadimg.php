        ...
        <div class="dashbody">
            <div class="card">
                <div class="card-header sec-card-head justify-content-between align-items-center <?php if($_SERVER['HTTP_REFERER'] != $url){ echo "py-2"; } ?>">
                    <div><h5 class="card-head-title">Upload Image</h5></div>
                    <div class="btn-actions-pane-right">
                        <?php if($_SERVER['HTTP_REFERER'] != $url){ ?>
                ...
                <div class="card-body">
                    <div class="alert-info rounded p-3">
                        ...
                        <ul class="mb-0 pl-3">
                            ...
                            <?php if($getconfingdetails[0]['crop_enabled'] == 1){ echo $getconfingdetails[0]['crop_width']." Px And Height : ".$getconfingdetails[0]['crop_height']; } else{ echo $getconfingdetails[0]['default_image_width']." Px And Height : ".$getconfingdetails[0]['default_image_height'];} ?> Px</b></li><li class="mb-1">You can upload only <b><?php echo $getconfingdetails[0]['max_image_count'] ?> images</b></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="prod-thumb-col row m-0 sortable">
                            ...
                            for($j=0;$j<count($getimagesinv);$j++){ ?>
                                <div class="mb-3 mr-1 mr-sm-2 inven-chk-col" id='<?=$getimagesinv[$j]['id']; ?>' data-prod='<?=$getinv[$i]['id']; ?>'>
                                    <div class="p-2 mb-2 position-relative iven-thumb-col border d-flex flex-wrap align-content-center rounded"><img src="<? echo SITEURL."/".$img_location."/".$getimagesinv[$j]['img_name']; ?>" class="img-fluid rounded" alt="inventory image"/> <span class="del-upload-pic text-center removeopt pro-attr-badge-action shadow-sm btn btn-danger btn-sm p-1" onclick="del_prod_img('<?php echo $getimagesinv[$j]['id'] ?>','<?php echo $getimagesinv[$j]['img_name'] ?>')"><i class="fa fa-trash"></i></span></div>
            ...
            <div class="text-right"><a href="<?php echo VENDORURL ?>product/viewproduct.php" class="btn btn-primary">Finish</a></div>
...
function finish(){ location.href = '<? echo  VENDORURL ?>product/viewproduct.php '; }
</script>
</body>
</html>