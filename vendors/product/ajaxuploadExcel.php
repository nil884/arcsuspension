<?php include("../../includes/configuration.php"); include("../../PHPExcel/Classes/PHPExcel/IOFactory.php");
$target="../../cronjob/cronfiles/";
    ...
    if(in_array($ext, $allowedExtensions)){
        ...
        $data = array( "uploadedBy"=>$_SESSION['seller'], "startDate"=>date("Y-m-d H:i:s"), "showname"=>$file,
        "filename"=>$photo, "status"=>"Initiate", "totalRow"=>$total_rows );
        $in = insertQuery(PRODCRON,$data);
        echo 1;
    } else { echo 'This type of file not allowed!'; }
    } else { echo 'Select an excel file first!'; }
    unlink($file);
?>