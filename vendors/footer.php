...
<!--Delete Popup-->
<div class="modal delete-modal" id="del_popup"><div class="modal-dialog modal-sm"><div class="modal-content"><div class="modal-body"><p class="cc-margin-bottom-0" id="del_message"></p></div><div class="modal-footer"><button type="button" class="btn btn-primary btn-sm" id="popup_ok">Ok</button><button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">Close</button></div></div></div></div>
...
function del_alertbox(msg,i,funct,type){
    $("#del_popup").modal("show"); $("#del_message").html(msg); $("#popup_ok").attr("onclick", funct+"('" + i + "','" + type + "')");
}
//Click on back button go on previous page    
