...
$where = 'parent_cat='.$categorydetails[0]['id'];
$productfilters = $prod->getProductsFilters("parent_cat",$categorydetails[0]['id']);
$pagetitle = $categorydetails[0]['page_title'];
$bread = $prod-> getBreadcrumb("parent_cat",$categorydetails[0]['id']); ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <title><?=($pagetitle!=""?$pagetitle." : ".SITE_TITLE:$bread['parent']." : ".SITE_TITLE); ?></title>
    ...
    <meta property="og:title" content="<?=($pagetitle!=""?$pagetitle." : ".SITE_TITLE:$bread['parent']." : ".SITE_TITLE); ?>">
    ...
    <meta property="twitter:title" content="<?=($pagetitle!=""?$pagetitle." : ".SITE_TITLE:$bread['parent']." : ".SITE_TITLE); ?>">
...
<div class="main-wrap">
    ...
    <div class="container"><ol class="breadcrumb mb-0 pl-0 pb-0 mb-3"><li class="breadcrumb-item"><a href="<?=SITEURL; ?>" hreflang="en">Home</a></li><li class="breadcrumb-item"><a class="point1" hreflang="en"><?=$bread['parent']; ?></a></li></ol></div>
        ...
        <div class="row">
            <div class="col-md-4 col-lg-3 filter-aside">
                ...
                <div id="accordion">
                    ...
                    if(count($val)){  $oriname=($key!="company"&&$key!="price"&&$key!="category"&&$key!="subcategory"?getOriginalName($key):$key); ?>
                        ...
                        <div id="collapse<?=$filtercnt; ?>" class="collapse show" data-parent="#accordion">
                            <div class="card-body pl-0 pb-1 pt-3 pr-0">
                                ...
                                <div class="custom-control custom-checkbox mb-2 cc-cursor-pointer">
                                    ...
                                    <label class="custom-control-label cc-cursor-pointer text-muted" for="<?=$key.$i ?>"><?  if($val[$i] != "") { echo $val[$i]; }  else { echo "Other"; }; ?></label>
                                </div>
                                <? } }else{ ?>
...
$(".fil-item-btn, .back-filter").click(function(){ $(".filter-aside").slideToggle(); $("body").toggleClass("filter-collapsed"); });  
$(".sort-item-btn, .model-popup").click(function(){ $(".sortnav").slideToggle(); $("body").toggleClass("sort-collapsed"); });
$(document).ready(function(){ $("#amount").parents(".filter-cat-body").removeClass("filter-cat-body").removeAttr("style"); });
</script>
</body>
</html>