...
class emailAccount
{
  ...
  * @ignore
  */
	function __construct($host, $username, $password, $port = 2082, $ssl = false, $theme = 'x', $address)
	{
		$this->HTTP = new HTTP($host, $username, $password, $port, $ssl, $theme);
		if(strpos($address, '@'))
		{
...
class Domain
{
  ...
  * @ignore
  */
	function __construct($host, $username, $password, $port = 2082, $ssl = false, $theme = 'x', $domain)
	{
		$this->HTTP = new HTTP($host, $username, $password, $port, $ssl, $theme);
		$this->domain = $domain;
	}
...
class FTPAccount
{
  ...
  * @ignore
  */
	function __construct($host, $username, $password, $port = 2082, $ssl = false, $theme = 'x', $account)
	{
		$this->HTTP = new HTTP($host, $username, $password, $port, $ssl, $theme);
...
class Database
{
  ...
  */
	...
	function __construct($host, $username, $password, $port = 2082, $ssl = false, $theme = 'x', $database)
	{
		$this->HTTP = new HTTP($host, $username, $password, $port, $ssl, $theme);
...
class databaseUser
{
  ...
  * @ignore
  */
	function __construct($host, $username, $password, $port = 2082, $ssl = false, $theme = 'x', $user)
	{
		$this->HTTP = new HTTP($host, $username, $password, $port, $ssl, $theme);
		$this->user = $user;
	}
...
class Redirect
{
  ...
  * @ignore
  */
	function __construct($host, $username, $password, $port = 2082, $ssl = false, $theme = 'x', $path)
	{
		$this->HTTP = new HTTP($host, $username, $password, $port, $ssl, $theme);
		$this->path = '/' . $path;
	}
