...
<div class="page-body-wrapper">
    ...
    <div class="main-panel">
        <div class="dashbody">
            ...
            <div class="card mb-0">
                <div class="card-header sec-card-head justify-content-between align-items-center"><div><h2 class="card-head-title">Failed Order (<?=$order->getVendorOrdersCount("","failure"); ?>)</h2></div></div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="display table table-bordered neworder-table" >
                            ...
                            <tbody>
                                <?php $orderdata = $order->getVendorOrders("","failure");
                                if(count($orderdata)){
