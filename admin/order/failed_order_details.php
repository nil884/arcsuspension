...
<html lang="en">
<head>
    <title><?php echo SITE_TITLE; ?> : Failed Orders Details</title>
...
<div class="page-body-wrapper">
    ...
    <div class="main-panel"> 
        <div class="dashbody">
            <?php $txnid = $_GET['transid']; $orderdata = $order->getOrderFullDetails($txnid); $all_item_detail = ""; $free_ship = "";
           /*  $item_detail = $order->getVendororder_item($orderdata['id']);  */
            $item_detail=selectQuery(ORDERSUB,"*","order_id=".$orderdata['id']);?>
            <div class="card">
                <div class="card-header sec-card-head justify-content-between align-items-center py-2">
                    <div><h5 class="card-head-title">Failed Order Details</h5></div>
                ...
                <div class="card-body p-0">
                    <div class="row m-0">
                        <div class="ord-short-det-col border-right px-0">
                            <div class="p-3">
                                <div class="cc-fw-5 text-primary">Transaction Date</div>
                        ...
                        <? if($orderdata['discount_amount']!=0){ ?>
                            <div class="ord-short-det-col border-right px-0">
                                <div class="p-3">
                                    <div class="cc-fw-5 text-primary">Discount </div>
                                    <div><?=$orderdata['discount_amount']; ?></div>
                                </div>
                            </div>
                        <? } ?>
                        <div class="ord-short-det-col border-right px-0">
                ...
                <div class="col-md-12 col-lg-12 col-xl-9">
                   ...
                   $pid=($getprodid[0]['parent_id']!=0?$getprodid[0]['parent_id']:$order_item['product_id']);
                    ...
                    <div class="card border-bottom order-succ-row">
                        <div class='row mx-0'>
                            <div class='col-lg-2 py-3 del-suc-data-col'><img src='<?=$img;?>' alt="order-det-thumb" height="120" class="mw-100 img-thumbnail"></div>
                            <div class='col-lg-10 py-3 del-suc-data-col'>
                                <div class='row'>
                                    <div class='col-lg-7'>
                                    <span class='cc-fw-5'><a href="<?=ADMINURL; ?>product/view-details.php?prod_id=<?=base64_encode($pid); ?>" target="_blank"><?=$order_item['product_name'];?></a></span>
                                       <?=$free_ship;?>
