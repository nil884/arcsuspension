...
<html lang="en">
<head>
    <title><?php echo SITENAME; ?> : Export Products</title>
...
<div class="page-body-wrapper">
    ...
    <div class="main-panel">
        <div class="dashbody">
            <div class="card">
                <div class="card-header sec-card-head justify-content-between align-items-center"><h2 class="card-head-title">Exoprt Products</h2></div>
                <div class="card-body pb-2">
                    ...
                    <form id="prodct_add_form" action="<?=$_SERVER['PHP_SELF'];?>"  method="post">
                        <div class="row">
                            <div class="col-md-12 col-lg-6">
                                <div class="form-group row">
                                    <label class="col-md-3 col-lg-4 col-form-label">Parent Category</label>
                            ...
                            <div class="col-md-12 col-lg-6">
                                <div class="form-group row">
                                    <label class="col-md-3 col-lg-4 col-form-label">Master Category</label>
                                    <div class="col-md-6 col-lg-8">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-lg-6">
                                <div class="form-group row">
                                    <label class="col-md-3 col-lg-4 col-form-label">Sub Category</label>
                                    <div class="col-md-6 col-lg-8">
                        ...
                        <div class="row border-top pt-2 text-right"><div class="col-12"><button class="btn btn-primary" type="submit">Export Products</button></div></div>
...
<script>$('.product-data-table').DataTable(); </script>
<script>
