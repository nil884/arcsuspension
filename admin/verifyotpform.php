<?php include("../includes/configuration.php");
    $uname = $_REQUEST['admin_username']; $pwd = $_REQUEST['admin_password']; $getuser = selectQuery(ADMIN,"*","username='".$uname."' and password='".password_encrypt($pwd)."' and isActive='1'");
    if(count($getuser) == 1){ $mobile = $getuser[0]['u_mob']; }
?>
<!DOCTYPE HTML>
<html lang="en">
<head>
    <title><?php echo SITENAME; ?> : Admin OTP Verification</title>
    <meta charset="UTF-8">
...
<div class="container">
    <div class="row">
        <div class="col-md-12 min-vh-100 d-flex flex-column justify-content-center">
            <div class="row">
                <div class="col-sm-10 col-md-7 col-lg-5 col-xl-4 mx-auto">
...
function verifyotp(){
    ...
    if(otp != ""){
        ...
        $(".msgs").fadeIn().html("Please enter OTP").addClass("alert alert-danger").delay(3000).fadeOut();
    }   
}
