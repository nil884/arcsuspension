...
<html lang="en">
<head>
    <title><?php echo SITE_TITLE; ?> : Profit Report</title>
...
<div class="page-body-wrapper">
    ...
    <div class="main-panel">
        <div class="dashbody">
        <div class="card card-body"><div class="alert alert-info mb-0">Net Profit = Gross Profit - Shipping Charges - Tax Paid On Selling The Product - Tax Paid On Purchasing The Product</div></div>
           <div class="card edit_template">
                <div class="card-header sec-card-head justify-content-between align-items-center"><div><h2 class="card-head-title">Profit Report</h2></div></div>
...
function loaddatatable(){
    ...
    table.buttons().container().appendTo('.prof-rep-excel');
}
function generateReport(){
    ...
    if(fromdt!=""&&todt!=""){
        ...
        var info = {fromdt:fromdt,todt:todt,action:"generateprofit_report"};
        $.ajax({ 
            type:"POST",
            url:"ajaxdata.php",
            data:info,
