...
<html lang='en'>
<head>
    <title><?php echo SITENAME; ?> : Update Favicon Images</title>
...
<div class="page-body-wrapper">
    ...
    $getconfingdetails = json_decode(getimgconfig('favicon'));
        ...
        <div class="dashbody">
            ...
            <div class="card mb-0">
                <div class="card-header sec-card-head justify-content-between align-items-center py-2">
                    <div><h2 class="card-head-title">Favicon Image</h2></div>
                ...
                <div class="card-body">
                    ...
                    <div id="imgdata" class="imgdata">
                        ...
                        <div class="row">
                            <?php if($getconfigdetails[0]['favicon'] != "" ){ ?>
                            <div class="col-6 col-sm-4 col-md-3 col-lg-3 col-xl-3">
                                <div class="position-relative border p-3 mb-2 w-75 mw-100 bg-light"><img src="<? echo SITEURL."/".$img_location."/".$getconfigdetails[0]['favicon']; ?>" alt="upload-img" class="img-fluid"/></div>
                            </div>
...
<script>
    var imgconf='<?=getimgconfig('favicon'); ?>';
...
window.addEventListener('DOMContentLoaded', function(){
    document.getElementById('crop').addEventListener('click', function(){
        ...
        if (cropper){
            ...
            formData.append('action','upload favicon');
