...
<div class="page-body-wrapper">
    ...
    $getconfingdetails = getimgconfigpaths('main slider mobile');
    $getsliderimg = selectQuery(MAIN_SLIDER_MOBILE,"img_id,img_name"," 1 order by priority ASC");
...
<script>
    var imgconf='<?=getimgconfig('main slider mobile'); ?>';
