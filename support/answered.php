...
<html lang='en'>
<head>
    <title><?php echo SITENAME; ?> : Answered Ticket</title>
        ...
        <div class="dashbody">
            <div class="card">
                <div class="card-header sec-card-head justify-content-between align-items-center">
                    <div><h5 class="card-head-title">Answered Ticket <span class="badge badge-warning"><?php echo count($getans); ?></span></h5></div>
                </div>
                <div class="card-body">
...
$(document).ready(function(){
    var dataTable = $('#guest-grid').DataTable({
        ...
        "ajax":{
            ...
            type: "post",
            data : {wherecond:"<?php echo $answeredwhere; ?>"},
            error: function(){
