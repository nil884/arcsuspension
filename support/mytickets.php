...
<html lang='en'>
<head>
    <title><?php echo SITENAME; ?> : Mytickets</title>
        ...
        <div class="dashbody">
            <div class="card">
                <div class="card-header sec-card-head justify-content-between align-items-center">
                    <div><h5 class="card-head-title">My Tickets <span class="badge badge-success"><?php echo count($getmytkt); ?></span></h5></div>
                </div>
                <div class="card-body">
...
$(document).ready(function(){
    var dataTable = $('#guest-grid').DataTable({
        ...
        "ajax":{
            ...
            type: "post",
            data : {wherecond:"<?php echo $mytktwhere; ?>"},
            error: function(){
